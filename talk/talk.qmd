...
![](images/papercutter.png){.absolute top="15%" left="0%" width="45%"}

## Designing a more reproducible scientific enterprise

![](images/papercutter.png){.absolute top="15%" left="0%" width="45%"}

![](images/norman_cover.png){.absolute top="15%" left="60%" width="30%"}
...
![](images/nudge.png){.absolute top="15%" left="60%" height="70%"}
...
![](images/button_title.png){.absolute top="15%" left="0%" width="40%"}
![](images/button_journal.png){.absolute top="40%" left="5%" width="30%"}
![](images/button_figure.png){.absolute top="50%" left="0%" width="45%"}
...
![](images/winners_curse.png){.absolute top="30%" left="55%" width="40%"}
...
![](images/Figure1_2025.png){.absolute top="10%" left="5%" width="80%"}
...
::: {.absolute top=85% left="70%" style="text-align: center;"}
...
::: {.absolute top=49% left="65%" style="font-size: 1.5em;"}
```
data[:,train]
data[:,test]
```
...
::: {.absolute top=68% height="70%" left="65%" style="font-size: 1.5em;"}
**Results: 53% accuracy**
:::
